...
const asd =()=>{
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center" onClick={asd}>
     <img src={circle1} className='absolute  top-[10%] left-[15%]' />
     <img src={circle2} className='absolute bottom-[10%] right-[15%]' />
